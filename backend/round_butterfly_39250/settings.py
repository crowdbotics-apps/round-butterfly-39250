"""
Django settings for round_butterfly_39250 project.
...
ROOT_URLCONF = 'round_butterfly_39250.urls'
...
WSGI_APPLICATION = 'round_butterfly_39250.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "round_butterfly_39250 API",
    "DESCRIPTION": "API documentation for round_butterfly_39250 App",
    "VERSION": "v1",
}
